...
import lightningv08.cryptonite.databinding.ActivityAesDecryptBinding;

public class AESDecryptActivity extends AppCompatActivity {

    private ActivityAesDecryptBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAesDecryptBinding.inflate(getLayoutInflater());
