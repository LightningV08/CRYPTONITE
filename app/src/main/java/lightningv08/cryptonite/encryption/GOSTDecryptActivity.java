        ...
        binding.decryptButton.setOnClickListener(v -> {
            ...
            executor.execute(new AsyncExecutor.AsyncExecutable() {
                ...
                public void doInUIThread() {
                    if (finished) {
                        if (success) {
                            Toast.makeText(GOSTDecryptActivity.this, R.string.file_decrypted, Toast.LENGTH_SHORT).show();
                            setResult(RESULT_OK, getIntent());
                        } else
                            Toast.makeText(GOSTDecryptActivity.this, R.string.decryption_error, Toast.LENGTH_SHORT).show();
                    }
                }
            });
        });
